...
class TestGenerator:
    ...
    def test_build_prompt_basic(self):
        ...
        assert self.generator.SYSTEM_PROMPT in prompt
        assert "What is AI?" in prompt
        assert "CONTEXT" in prompt
        assert "Chunk 1" in prompt
        assert "Chunk 2" in prompt
        assert "test1.md" in prompt
        assert "test2.md" in prompt
    ...
    def test_extract_structured_citations_numeric(self):
        ...
        citations = self.generator._extract_structured_citations(response, self.test_chunks)
    ...
    def test_infer_citations_from_content(self):
        ...
        citations = self.generator._infer_citations_from_content(response, self.test_chunks)
    ...
    def test_clean_response_text(self):
        ...
        dirty_response = "This is [1] a response [Source: test.md] with citations [note.md]."
    ...
    def test_format_citations(self):
        ...
        citations = [
            ...
            Citation(file_path="test2.md", title="Test 2", snippet="a" * 400)  # Too long
        ]
    ...
    def test_property_based_citation_completeness(self):
        ...
        for response in citation_responses:
            ...
            for citation in citations:
                ...
                assert any(c.file_path == citation.file_path for c in self.test_chunks), \
    ...
    def test_property_based_history_limit(self):
        ...
        for i in range(10):
            ...
            long_history.append(ChatTurn(role="assistant", content=f"Assistant answer {i}"))
        
        prompt = self.generator._build_prompt("Current question", self.test_chunks, long_history)
        ...
        total_history_turns = user_count + assistant_count - 2  # Exclude current question
