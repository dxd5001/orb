...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        logger.info(f"Embedding provider: {config_manager.get_config('EMBEDDING_PROVIDER')}")
        ...
        logger.info(f"Embedding backend initialized: {app.state.embedding_backend.get_model_name()}")
        ...
        logger.info(f"LLM backend initialized: {app.state.llm_backend.get_model_name()}")
